...
const Login = ({ onLogin }) => {
  ...
  const [role, setRole] = useState('manager') // 'manager' or 'user'
  ...
  const handleOtpVerified = async (otp) => {
    ...
    try {
      ...
      // authAPI returns { success, message, data: { user, access_token, refresh_token } }
      ...
      // authAPI.login throws a string error message on failure
                    ...
                    {!isLogin && (
                      ...
                      "
                        ...
                        `}
                          >
                            <div className="flex items-center justify-between w-full mb-1.5">
                              <div className={`p-1.5 rounded-lg ${role === 'manager' ? 'bg-indigo-600 text-white' : 'bg-slate-100 text-slate-600'}`}>
                            ...
                            <p className="text-[13px] font-bold text-slate-900">Project Manager</p>
                            <p className="text-[11px] text-slate-500 mt-0.5 leading-tight">Create & assign projects/tasks</p>
                          </button>
                        ...
                        `}
                          >
                            <div className="flex items-center justify-between w-full mb-1.5">
                              <div className={`p-1.5 rounded-lg ${role === 'user' ? 'bg-indigo-600 text-white' : 'bg-slate-100 text-slate-600'}`}>
                            ...
                            <p className="text-[13px] font-bold text-slate-900">Team Member (User)</p>
                            <p className="text-[11px] text-slate-500 mt-0.5 leading-tight">View assigned projects & tasks</p>
                          </button>
                        </div>
                      </div>
                    )}
